...
import com.young.gulimall.ware.service.WmsPurchaseService;
...
public class WmsPurchaseController {
    ...
    public ResponseResult info(@PathVariable("id") Long id){
        ...
        return ResponseResult.ok().put("wmsPurchase", wmsPurchase);
    }
     ...
     */
    @RequestMapping("/save")
    public ResponseResult save(@RequestBody WmsPurchaseEntity wmsPurchase){
    ...
    public ResponseResult update(@RequestBody WmsPurchaseEntity wmsPurchase){
